#!/usr/bin/env python3
"""
colab_train_v29_2_interaction_calibrated.py
PHASE 29.2: INTERACTION-CALIBRATED MESOSCOPIC ENGINE
==============================================================
Production Candidate — Contrast Stable — Topology + Regime Interactions.
"""
...
logger = logging.getLogger("V29.2.Interaction")
...
def main():
    logger.info("="*60)
    logger.info("🧠 PHASE 29.2 — REGIME INTERACTION CALIBRATED ENGINE")
    logger.info("="*60)
    ...
    mp = f"{OUT_DIR}/v29_2_interaction_calibrated_engine.pth"; cp = f"{OUT_DIR}/v29_2_config.json"
    torch.save(model.to("cpu").state_dict(), mp)
    cfg = {
        "version": "29.2", 
        "architecture": "Factorized Structural Head + Regime Interaction Calibrator",
    ...
    torch.save(model.state_dict(), f"{DRIVE_DIR}/v29_2_interaction_calibrated_engine.pth")
    logger.info(f"✅ V29.2 Engine saved to {mp} and Drive.")
