...
def main():
    ...
    for ep in range(STAGE_A_EP + STAGE_B_EP):
        ...
        for bi, batch in enumerate(loader):
            ...
            if not is_stage_b:
                ...
                loss = Loss_struct + 2.5 * Loss_outcome
    ...
    mp = f"{OUT_DIR}/v30_1_spectral_basis_engine.pth"; cp = f"{OUT_DIR}/v30_1_config.json"
    torch.save(model.to("cpu").state_dict(), mp)
    cfg = {
        "version": "30.1", 
        "architecture": "Multi-Basis Spectral Structural Engine",
    ...
    torch.save(model.state_dict(), f"{DRIVE_DIR}/v30_1_spectral_basis_engine.pth")
    logger.info(f"✅ V30.1 Engine saved to {mp} and Drive.")
