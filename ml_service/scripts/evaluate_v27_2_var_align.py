#!/usr/bin/env python3
"""
evaluate_v27_2_var_align.py
PHASE 27.2: VARIANCE ALIGNED SUPERVISION
==============================================================
Validates the V27.2 Variance-Aligned Simulator Engine.
...
def main():
    ...
    print("=" * 60)
    print("🧠 PHASE 27.2: VARIANCE ALIGNED SUPERVISION EVALUATION")
    print("=" * 60)
    print(f"Device: {device}")

    paths = [
        ("models/cattle/v27_2_var_align_engine.pth", "models/cattle/v27_2_config.json"),
        ("v27_2_var_align_engine.pth", "v27_2_config.json"),
        ("/content/drive/MyDrive/HerdV24/v27_2_var_align_engine.pth", "/content/drive/MyDrive/HerdV24/v27_2_config.json"),
    ]
    ...
    if all_ok: print("🏆 PHASE 27.2 COMPLETE — Variance Aligned Engine Active")
    else: print("❌ Phase 27.2 FAILED — Constraints broken.")
    print("=" * 60)
