#!/usr/bin/env python3
"""
colab_train_v27_2_var_align.py
PHASE 27.2: VARIANCE ALIGNED SUPERVISION
==============================================================
Provides lean contextual inter-pen structural reasonings for gOmATA,
using contrastive ranking and variance alignment objectives.
"""
...
logger = logging.getLogger("V27.2.VarAlign")
...
def main():
    logger.info("="*60)
    logger.info("🧠 Phase 27.2 — Variance Aligned Target")
    logger.info("="*60)
    ...
    mp = f"{OUT_DIR}/v27_2_var_align_engine.pth"; cp = f"{OUT_DIR}/v27_2_config.json"
    torch.save(model.to("cpu").state_dict(), mp)
    cfg = {
        "version": "27.2", 
        "architecture": "Frozen V21 + Variance-Aligned Simulator Supervision",
    ...
    torch.save(model.state_dict(), f"{DRIVE_DIR}/v27_2_var_align_engine.pth")
    logger.info(f"✅ V27.2 Engine saved to {mp} and Drive.")
