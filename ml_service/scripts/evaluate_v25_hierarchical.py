#!/usr/bin/env python3
"""
evaluate_v25_hierarchical.py
PHASE 25: HIERARCHICAL INTER-PEN TRANSFORMER
==============================================================
Validates the V25 Hierarchical Reasoning Engine.
...
class MiniStructuralEncoder(nn.Module):
    def __init__(self, in_dim=96, hidden=16, out_dim=48):
        super().__init__()
...
def main():
    ...
    print("=" * 60)
    print("🧠 PHASE 25: PRODUCTION HIERARCHICAL REASONING EVALUATION")
    print("=" * 60)
    print(f"Device: {device}")

    paths = [
        ("models/cattle/v25_hierarchical_engine.pth", "models/cattle/v25_config.json"),
        ("v25_hierarchical_engine.pth", "v25_config.json"),
        ("/content/drive/MyDrive/HerdV24/v25_hierarchical_engine.pth", "/content/drive/MyDrive/HerdV24/v25_config.json"),
    ]
    ...
    print(f"Pure Mesoscopic Structural Params: {pen_params:,} (Target < 45k)")
    print(f"Variance amplification alpha: {alpha_val:.4f} (Bounded [0.5, 3.0])")
    ...
    print("\n" + "="*60)
    all_ok = md>=0.97 and mv>=0.92 and mp>=0.75 and res['pen_min']>=0.55 and pen_params <= 45000
    if all_ok: print("🏆 PHASE 25 COMPLETE — Hierarchical Engine Active")
    else: print("❌ Phase 25 FAILED — Constraints broken.")
    print("=" * 60)
