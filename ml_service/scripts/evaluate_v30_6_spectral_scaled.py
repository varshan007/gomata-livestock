...
class DualHeadPenEngine(nn.Module):
    ...
    def compute_pen_outcomes(self, pen_struct_basis, herd_ctx, regime_idx, outbreak, vacc_rank, seed_density, temp_factor, vacc_ratio):
        ...
        # Spectral scaling
        struct_scaled = self.spectral_scaler(pen_struct_basis)
...
def evaluate_multi_seed(model, device, n_farms=200):
    ...
    print(f"\n✅ All Phase 30.6 Evaluation Target Outcomes Verified on 10,000 Farms.")
    model.eval()
...
def main():
    ...
    print("=" * 60)
    print("🧠 PHASE 30.6: SPECTRAL-SCALED INTERACTION ENGINE")
    print("=" * 60)
    print(f"Device: {device}")

    paths = [
        ("models/cattle/v30_6_spectral_scaled_engine.pth", "models/cattle/v30_6_config.json"),
        ("v30_6_spectral_scaled_engine.pth", "v30_6_config.json"),
        ("/content/drive/MyDrive/HerdV24/v30_6_spectral_scaled_engine.pth", "/content/drive/MyDrive/HerdV24/v30_6_config.json"),
    ]
    ...
    if all_ok: print("🏆 PHASE 30.6 COMPLETE — Valid Physics Corrected Engine Generated")
    else: print("❌ Phase 30.6 FAILED — Constraints broken.")
    print("=" * 60)
