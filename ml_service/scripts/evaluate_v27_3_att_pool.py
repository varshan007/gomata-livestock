#!/usr/bin/env python3
"""
evaluate_v27_3_att_pool.py
PHASE 27.3: ATTENTION POOLING ALIGNMENT
==============================================================
Validates the V27.3 Attention-Pooled Simulator Supervision.
...
def main():
    ...
    print("=" * 60)
    print("🧠 PHASE 27.3: ATTENTION POOLED ALIGNMENT EVALUATION")
    print("=" * 60)
    print(f"Device: {device}")

    paths = [
        ("models/cattle/v27_3_att_pool_engine.pth", "models/cattle/v27_3_config.json"),
        ("v27_3_att_pool_engine.pth", "v27_3_config.json"),
        ("/content/drive/MyDrive/HerdV24/v27_3_att_pool_engine.pth", "/content/drive/MyDrive/HerdV24/v27_3_config.json"),
    ]
    ...
    print(f"Pure Mesoscopic Structural Params: {pen_params:,} (Target < 150k)")
    ...
    print("\n" + "="*60)
    all_ok = md>=0.97 and mv>=0.92 and mp>=0.82 and res['pen_min']>=0.55 and pen_params <= 150000
    if all_ok: print("🏆 PHASE 27.3 COMPLETE — Attention-Pooled Engine Active")
    else: print("❌ Phase 27.3 FAILED — Constraints broken.")
    print("=" * 60)
