...
def main():
    ...
    print("=" * 60)
    print("🧠 PHASE 30.3: PEN-CONDITIONAL FACTORIZED EPIDEMIC ENGINE")
    print("=" * 60)
    print(f"Device: {device}")

    paths = [
        ("models/cattle/v30_3_pen_conditional_fixes_engine.pth", "models/cattle/v30_3_fixes_config.json"),
        ("v30_3_pen_conditional_fixes_engine.pth", "v30_3_fixes_config.json"),
        ("/content/drive/MyDrive/HerdV24/v30_3_pen_conditional_fixes_engine.pth", "/content/drive/MyDrive/HerdV24/v30_3_fixes_config.json"),
    ]
    ...
    if all_ok: print("🏆 PHASE 30.3 COMPLETE — Valid Factorization Model Generated")
    else: print("❌ Phase 30.3 FAILED — Constraints broken.")
    print("=" * 60)
