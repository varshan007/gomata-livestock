...
def main():
    ...
    paths = [
        ("models/cattle/v30_3_pen_conditional_engine.pth", "models/cattle/v30_3_config.json"),
        ("v30_3_pen_conditional_engine.pth", "v30_3_config.json"),
        ("/content/drive/MyDrive/HerdV24/v30_3_pen_conditional_engine.pth", "/content/drive/MyDrive/HerdV24/v30_3_config.json"),
    ]
